...
write.table(df2,file = "C:/Users/rudolpa/OneDrive - Jacobs/R Training/Cleaning Data Course/getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/final_table.txt")